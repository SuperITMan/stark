...
/**
 * [Structural Directive](https://v7.angular.io/guide/structural-directives#structural-directives) to show an element if the user has any of the roles specified
