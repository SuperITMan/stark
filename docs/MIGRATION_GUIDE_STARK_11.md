...
#### 1.3. Edit `projects.<project_name>.architect.build.configurations.hmr`:
...
As all the stark-ui styles are configured thanks to `set-stark-ui-styles` method, you remove
